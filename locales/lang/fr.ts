export default {
    ...
    career: {
        ...
        rgu: {
            ...
            description: "Mon projet de stage consiste à développer un chatbot IA en Python utilisant FastAPI pour le backend, React JS pour le frontend, et DiCE pour le modèle d'IA explicative."
        }
    },
    projects: {
        leitlearn: {
