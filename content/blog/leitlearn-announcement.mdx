export const metadata = {
  ...
  author: [
    ...
    {name: 'Aiman Manchout', image: '/users/1722035304181.avif', link: 'https://www.linkedin.com/in/aiman-manchout/'}
  ],
};

![Leitlearn Demo Dashboard](https://i.ibb.co/f1g1Yx8/Capture-d-e-cran-2025-01-26-a-11-52-26.png)

From **December 2024**, I embarked on an exciting journey to **revive and reinvent Leitlearn.com**, a web platform based on the **Leitner method** of spaced repetition using flashcards.
...
With persistence and iterative improvements, I was able to overcome these hurdles, creating a platform that is fast, reliable, and enjoyable to use.
...
This project has been a personal milestone, combining my passion for education and technology into a tangible solution that can help others achieve their learning goals.
